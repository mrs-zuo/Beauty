...
{
    public class Task_CController : Base_CController
    {
        [HttpPost]
        ...
        public HttpResponseMessage GetScheduleList(JObject obj)
        {
            ...
            int recordCount = 0;
            list = Task_CBLL.Instance.GetScheduleList(operationModel, out recordCount);
        ...
        public HttpResponseMessage AddSchedule(JObject obj)
        {
            ...
            res.Code = Task_CBLL.Instance.AddSchedule(addModel).ToString();
        ...
        public HttpResponseMessage GetScheduleDetail(JObject obj)
        {
            ...
            model = Task_CBLL.Instance.GetScheduleDetail(operationModel.CompanyID, operationModel.LongID);
        ...
        public HttpResponseMessage CancelSchedule(JObject obj)
        {
            ...
            res.Code = Task_CBLL.Instance.CancelSchedule(operationModel.CompanyID, operationModel.LongID, operationModel.UpdaterID, operationModel.Time).ToString();
