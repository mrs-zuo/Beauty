...
namespace ClientApi.Controllers.API
{
    public class TaskController : BaseController
    {
        ...
        public HttpResponseMessage AddSchedule(JObject obj)
        {
            ...
            if (addModel == null || addModel.TaskScdlStartTime == null || addModel.TaskSourceType <= 0)
            {
                res.Message = "不合法参数";
                return toJson(res);
            }
        ...
        [ActionName("EditTask")]
        [HTTPBasicAuthorize]
        public HttpResponseMessage EditTask(JObject obj)
        {
            ObjectResult<bool> res = new ObjectResult<bool>();
            res.Code = "0";
            res.Data = false;
            ...
            if (addModel == null || addModel.TaskScdlStartTime == null)
            {
                res.Message = "不合法参数";
                return toJson(res);
            }
            ...
            addModel.ReservationConfirmer = this.UserID;
            res.Data = Task_BLL.Instance.EditTask(addModel);
        ...
        [HttpPost]
        [ActionName("GetOrderToAppointment")]
        [HTTPBasicAuthorize]
        public HttpResponseMessage GetOrderToAppointment(JObject obj)
        {
            ObjectResult<GetScheduleDetail_Model> res = new ObjectResult<GetScheduleDetail_Model>();
            res.Code = "0";
            res.Data = null;
            ...
            if (operationModel == null || operationModel.OrderID <= 0)
            {
                res.Message = "不合法参数";
                return toJson(res);
            }
            ...
            GetScheduleDetail_Model model = new GetScheduleDetail_Model();
            model = Task_BLL.Instance.GetOrderToAppointment(operationModel.OrderID, this.CompanyID);
            res.Data = model;
            res.Code = "1";
            return toJson(res);
        }
        ...
        [HttpPost]
        [ActionName("GetTaskBasicInfo")]
        [HTTPBasicAuthorize]
        public HttpResponseMessage GetTaskBasicInfo(JObject obj)
        {
            ObjectResult<GetScheduleDetail_Model> res = new ObjectResult<GetScheduleDetail_Model>();
            res.Code = "0";
            res.Data = null;
            ...
            if (operationModel.BranchID <= 0 || operationModel.ProductCode <= 0)
            {
                res.Message = "不合法参数";
                return toJson(res);
            }
            ...
            GetScheduleDetail_Model model = new GetScheduleDetail_Model();
            model = Task_BLL.Instance.getTaskBasicInfo(this.CompanyID, operationModel.BranchID, operationModel.ProductCode);
