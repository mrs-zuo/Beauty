...
public class TodayServiceSearchActivity extends Activity implements OnClickListener{
	...
	private void saveConditionToSharePre(OrderListBaseConditionInfo currentCondition) {
		...
		String key = sharePreUtil.getAdvancedConditionKey(userinfoApplication.getAccountInfo().getAccountId(),userinfoApplication.getAccountInfo().getBranchId(), SharedPreferenceUtil.AdvancedFilterFlag.TodayServiceFlag);
