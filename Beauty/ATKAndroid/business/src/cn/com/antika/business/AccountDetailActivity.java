...
import cn.com.antika.implementation.GetServerAccountDetailDataTaskImpl;
...
public class AccountDetailActivity extends BaseActivity {
    ...
    private void createTableLayout(TableLayout tableLayout, int flag,
        ...
        if (flag == 1) {
            ...
            titleTextView.setTextColor(this.getResources().getColor(R.color.title_font));
    ...
    protected void onDestroy() {
        ...
        if (getAccountDetailDataThread != null) {
            getAccountDetailDataThread.interrupt();
            getAccountDetailDataThread = null;
        }
    }
}
