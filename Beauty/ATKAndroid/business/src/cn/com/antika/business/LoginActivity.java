...
import cn.com.antika.Thread.GetCompanyListForAccountThread;
...
import cn.com.antika.util.RSAUtil;
...
public class LoginActivity extends Activity implements OnClickListener {
    ...
    private static class LoginActivityHandler extends Handler {
        ...
        private LoginActivityHandler(LoginActivity activity) {
            WeakReference<LoginActivity> weakReference = new WeakReference<LoginActivity>(activity);
