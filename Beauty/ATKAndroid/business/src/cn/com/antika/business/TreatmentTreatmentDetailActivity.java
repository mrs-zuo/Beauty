...
import cn.com.antika.adapter.TreatmentAfterViewPagerAdapter;
import cn.com.antika.adapter.TreatmentBeforeViewPagerAdapter;
...
public class TreatmentTreatmentDetailActivity extends BaseActivity implements
    ...
    private static class TreatmentTreatmentDetailActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (treatmentTreatmentDetailActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
            if (msg.what == 1) {
