...
import cn.com.antika.fragment.ExpiredBenefitsFragment;
import cn.com.antika.fragment.UnUsedBenefitsFragment;
import cn.com.antika.fragment.UsedBenefitsFragment;
...
public class CustomerBenefitsActivity extends FragmentActivity {
    ...
    protected void setCurrentItemBackground(TextView currentItemText) {
        currentItemText.setTextColor(getResources().getColor(R.color.title_font));
    }
