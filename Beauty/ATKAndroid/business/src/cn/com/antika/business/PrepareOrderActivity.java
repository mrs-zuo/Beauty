...
import cn.com.antika.bean.BenefitSpinnerBean;
import cn.com.antika.bean.CustomerBenefit;
import cn.com.antika.bean.DownloadInfo;
import cn.com.antika.bean.EcardInfo;
import cn.com.antika.bean.EcardSpinnerBean;
		...
		if (orderProductList != null && orderProductList.size() != 0) {
			...
			for (int i = 0; i < orderProductList.size(); i++) {
				...
				if(orderProduct.isOldOrder()){
					...
					ImageButton prepareOrderPlusProductHasQuantityButton = (ImageButton) prepareOrderProductView.findViewById(R.id.prepare_order_plus_has_quantity_btn);
								...
								if (s != null && !s.toString().equals("")) {
									...
									for (int i = 0; i < orderProductList.size(); i++) {
										if(!orderProductList.get(i).isOldOrder()){
											double orderProductTotalSalePrice = 0;
											try {
												orderProductTotalSalePrice = Double.parseDouble((((TextView) prepareOrderProductListView.getChildAt(k).findViewById(R.id.prepare_order_product_total_sale_price)).getText().toString()));
											} catch (NumberFormatException e) {
