...
import cn.com.antika.adapter.OpportunityListAdapter;
...
import cn.com.antika.manager.OpportunityManager;
...
public class OpportunityListActivity extends BaseActivity implements OnClickListener, OnItemClickListener, XListView.IXListViewListener {
    ...
    private static class OpportunityListActivityHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            opportunityListActivity.dismissDialog(opportunityListActivity.progressDialog);
    ...
    private void refreshList(int flag) {
        ...
        OpportunityListBaseConditionInfo.OpportunityListConditionBuilder opportunityListConditionBuilder = new OpportunityListBaseConditionInfo.OpportunityListConditionBuilder();
