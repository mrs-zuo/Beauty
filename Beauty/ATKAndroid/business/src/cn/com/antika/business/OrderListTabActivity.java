...
import cn.com.antika.adapter.RelatedOrderPagerAdapter;
	...
	protected void  initTabView(){
		...
		relatedOrderViewPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageScrolled(int position, float offset,int offsetPiexls) {
				...
				switch (position) {
				case 0:
					tabTodayServiceTitle.setTextColor(getResources().getColor(R.color.title_font));
					break;
				case 1:
					tabRelatedOrderTitle.setTextColor(getResources().getColor(R.color.title_font));
					break;
				}
			}
			@Override
