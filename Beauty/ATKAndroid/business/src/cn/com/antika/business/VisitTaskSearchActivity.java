...
public class VisitTaskSearchActivity extends BaseActivity implements OnClickListener {
    ...
    private void saveConditionToSharePre() {
        ...
        String key = sharePreUtil.getAdvancedConditionKey(userinfoApplication.getAccountInfo().getAccountId(), userinfoApplication.getAccountInfo().getBranchId(), SharedPreferenceUtil.AdvancedFilterFlag.VisitTaskFlag);
