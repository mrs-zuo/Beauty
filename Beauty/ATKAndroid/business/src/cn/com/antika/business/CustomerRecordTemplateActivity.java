...
import cn.com.antika.manager.RecordTemplateManager;
...
public class CustomerRecordTemplateActivity extends BaseActivity implements OnItemClickListener, OnClickListener, XListView.IXListViewListener, RecordTemplateListAdapter.Callback {
    ...
    private static class CustomerRecordTemplateActivityHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (customerRecordTemplateActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
    ...
    private void requestData(int flag) {
        ...
        RecordTemplateListBaseConditionInfo.RecordTemplateListConditionBuilder recordTemplateListConditionBuilder = new RecordTemplateListBaseConditionInfo.RecordTemplateListConditionBuilder();
