...
public class ExpiredBenefitsFragment extends Fragment {
    ...
    private static class ExpiredBenefitsFragmentHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            FragmentActivity fragmentActivity = expiredBenefitsFragment.getActivity();
            ...
            switch (msg.what) {
                ...
                case Constant.LOGIN_ERROR:
                    DialogUtil.createShortDialog(fragmentActivity, expiredBenefitsFragment.getString(R.string.login_error_message));
                ...
                case Constant.APP_VERSION_ERROR:
                    ...
                    expiredBenefitsFragment.packageUpdateUtil = new PackageUpdateUtil(fragmentActivity, expiredBenefitsFragment.mHandler, fileCache, downloadFileUrl, false, expiredBenefitsFragment.userinfoApplication);
