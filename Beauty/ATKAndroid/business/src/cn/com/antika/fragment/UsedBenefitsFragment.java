...
public class UsedBenefitsFragment extends Fragment {
    ...
    private static class UsedBenefitsFragmentHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            FragmentActivity fragmentActivity = usedBenefitsFragment.getActivity();
            ...
            switch (msg.what) {
                ...
                case Constant.LOGIN_ERROR:
                    DialogUtil.createShortDialog(fragmentActivity, usedBenefitsFragment.getString(R.string.login_error_message));
                ...
                case Constant.APP_VERSION_ERROR:
                    ...
                    usedBenefitsFragment.packageUpdateUtil = new PackageUpdateUtil(fragmentActivity, usedBenefitsFragment.mHandler, fileCache, downloadFileUrl, false, usedBenefitsFragment.userinfoApplication);
