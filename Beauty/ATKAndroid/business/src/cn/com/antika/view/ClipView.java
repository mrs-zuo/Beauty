...
public class ClipView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		// left
		canvas.drawRect(0, (height - width) / 2, SX, (height + width) / 2,
				paint);
		// right
		canvas.drawRect(width - EX, (height - width) / 2, width,
		...
		canvas.drawLine(SX, (height - width) / 2, width - EX,
				(height - width) / 2, paintLine);
		canvas.drawLine(SX, (height - width) / 2, SX, (height + width) / 2,
				paintLine);
		canvas.drawLine(SX, (height + width) / 2, width - EX,
				(height + width) / 2, paintLine);
		canvas.drawLine(width - EX, (height - width) / 2, width - EX,
				(height + width) / 2, paintLine);
	}
}
