...
/**
 */
public class ExpiredBenefitsFragment extends BaseFragment implements OnClickListener,IConnectTask,OnItemClickListener {
	...
	private void initCustomerBenefitListView(){
		if(customerBenefitsList.size()>0){
			...
			for(int i=0;i<customerBenefitsList.size();i++){
				...
				View customerBenefitListItem=layoutInflater.inflate(R.xml.customer_benefit_failure_list_item,null);
