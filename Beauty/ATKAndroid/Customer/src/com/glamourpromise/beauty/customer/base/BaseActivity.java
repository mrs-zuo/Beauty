...
public abstract class BaseActivity extends Activity implements OnClickListener, IBaseView{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.customer_title_bar);
	...
	public void  setTitle(String title){
		((TextView)findViewById(R.id.navigation_title_text)).setText(title);
	}
	public void hiddenHead(){
		findViewById(R.id.base_head).setVisibility(View.GONE);
	}
	@Override
	...
	public void hideBackHome(){
		findViewById(R.id.btn_main_back).setVisibility(View.INVISIBLE);
		findViewById(R.id.btn_main_home).setVisibility(View.INVISIBLE);
	}
	...
	public static class BaseWebApiTask implements IConnectTask {
		...
		public BaseWebApiTask(BaseActivity activity) {
		...
		Dialog dialog = new AlertDialog.Builder(this)
				...
				.setNegativeButton(getString(R.string.cancel_update),
						new DialogInterface.OnClickListener() {
							@Override
							public void onClick(DialogInterface dialog, int which) {
								mApp.AppExit(BaseActivity.this);
							}
						}).create();
		dialog.show();
	...
	private void promptUpdateNewVersion(){
		...
		DownFileTaskProgressCallback progressCallback = new DownFileTaskProgressCallback() {
			...
			public void onPostExecute() {
				updateDialog.cancel();
				AlertDialog installApkdialog = DialogUtil.showInstallDialog(BaseActivity.this, new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog,int which) {
						mApp.installApk(BaseActivity.this);
					}
				});
			...
			public void onExecuteError() {
				updateDialog.cancel();
				DialogUtil.createShortDialog(BaseActivity.this, "更新失败！");
				mApp.AppExit(BaseActivity.this);
			}
		};
