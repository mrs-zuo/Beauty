...
//        setCacheColorHint(context.getResources().getColor(R.color.blue));
        ...
        headerView = (LinearLayout) inflater.inflate(R.xml.new_refresh_list_title, null);
    ...
    private void changeHeaderViewByState() {
        ...
        case DONE:
            ...
            lvHeaderProgressBar.setVisibility(View.GONE);
            lvHeaderArrowIv.clearAnimation();
            lvHeaderArrowIv.setImageResource(R.drawable.arrow_up);
            lvHeaderTipsTv.setText("下拉刷新");
            lvHeaderLastUpdatedTv.setVisibility(View.VISIBLE);
            break;
        }
    ...
    public void onRefreshComplete() {
		...
		lvHeaderLastUpdatedTv.setText("最近更新:" + currentTime);
//        lvHeaderLastUpdatedTv.setText("最近更新:" + DateFormat.format("yyyy-MM-dd HH:mm", new java.util.Date()));
        changeHeaderViewByState();
    }
