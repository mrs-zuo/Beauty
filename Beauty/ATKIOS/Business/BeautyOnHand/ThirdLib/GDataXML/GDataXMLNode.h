...
//+ (void)parseXML:(NSString *)xml viewController:(UIViewController *)viewController showSuccessMsg:(BOOL)showSuccessMsg showFailureMsg:(BOOL)showFailureMsg  success:(void(^)(int))success failure:(void(^)())failure;
