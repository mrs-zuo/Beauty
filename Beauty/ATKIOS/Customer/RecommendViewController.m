...
@property (assign, nonatomic) long long  detail;
...
- (void)requestAppointmentRecommendOperation
{
    ...
    NSDictionary *para = @{@"BranchID":@(_BranchID),
                           @"ImageWidth":@160,
                           @"ImageHeight":@160};
    getAppointmentRecommendOperation = [[GPCHTTPClient sharedClient] requestUrlPath:@"/Service/GetRecommendedServiceListByBranchID" showErrorMsg:YES parameters:para WithSuccess:^(id json) {
