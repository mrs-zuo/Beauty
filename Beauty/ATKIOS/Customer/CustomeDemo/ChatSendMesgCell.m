...
#define MessageText_Width 210.0f
...

{
    ...
    if (self) {
        ...
        headImageView = [[UIImageView alloc] initWithFrame:CGRectMake(10.0f, 30.0f, 40.0f, 40.0f)];
        [headImageView setImage:[UIImage imageNamed:@"People-default"]];
        [self.contentView addSubview:headImageView];
        
        
        dateLabel = [[UILabel alloc] initWithFrame:CGRectMake(50.0f, 10.0f, 117.0f, 21.0f)];
        [self.contentView addSubview:dateLabel];
        
        contentImgView = [[UIImageView alloc] initWithFrame:CGRectMake(55.0f, 30.0f, 235.0f, 55.0f)];
        [self.contentView addSubview:contentImgView];;
        
        messageLabel = [[MLEmojiLabel alloc] initWithFrame:CGRectMake(18.5f, 4.5f, MessageText_Width, 20.0f)];
        ...
        [contentImgView setImage:[[UIImage imageNamed:@"chat_messageWhite_bg"] resizableImageWithCapInsets:UIEdgeInsetsMake(23.5f, 31.0f, 19.5f, 31.0f)]];
 ...
 * 文本表情自适应
 */
//    CGSize size_Msg = [message.mesg_MessageContent sizeWithFont:kFont_Light_16 constrainedToSize:CGSizeMake(MessageText_Width, 330.0f)];
//    
...
//    CGSize size = [self.messageLabel sizeThatFits:CGSizeMake(220, FLT_MAX)];
    ...
    rect_Error.origin.x = messageLabel.frame.origin.x - 25.0f;
    [errorImgView setFrame:rect_Error];
    
    CGRect rect_ActivityView = self.activityView.frame;
    rect_ActivityView.origin.x = messageLabel.frame.origin.x- 25.0f;
