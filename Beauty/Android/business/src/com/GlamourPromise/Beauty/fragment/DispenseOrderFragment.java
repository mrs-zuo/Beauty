...
import com.GlamourPromise.Beauty.Business.PrepareOrderActivity;
import com.GlamourPromise.Beauty.Business.ProductAndOldOrderListActivity;
import com.GlamourPromise.Beauty.Business.R;
import com.GlamourPromise.Beauty.adapter.DispenseOrderListAdapter;
...
public class DispenseOrderFragment extends Fragment implements OnClickListener {
    ...
    private List<OrderProduct> orderProductList, userInfoAppOrderProductList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        userInfoAppOrderProductList = new ArrayList<OrderProduct>();
        userinfoApplication = (UserInfoApplication) getActivity().getApplication();
        if (userinfoApplication.getOrderInfo() != null) {
            orderProductList.addAll(userinfoApplication.getOrderInfo().getOrderProductList());
            // orderProductList = userinfoApplication.getOrderInfo().getOrderProductList();
            userInfoAppOrderProductList = userinfoApplication.getOrderInfo().getOrderProductList();
        }
        dispenseOrderListAdapter = new DispenseOrderListAdapter(getActivity(), orderProductList, userInfoAppOrderProductList);
