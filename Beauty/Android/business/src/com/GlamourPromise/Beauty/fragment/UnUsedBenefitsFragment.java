...
public class UnUsedBenefitsFragment extends Fragment{
	...
	private static class UnUsedBenefitsFragmentHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
				case 0:
					DialogUtil.createShortDialog(unUsedBenefitsFragment.getActivity(), (String) msg.obj);
					break;
				case 1:
					unUsedBenefitsFragment.initCustomerBenefitListView();
					break;
				case 2:
					DialogUtil.createShortDialog(unUsedBenefitsFragment.getActivity(), "您的网络貌似不给力，请重试");
					break;
				case Constant.LOGIN_ERROR:
					DialogUtil.createShortDialog(unUsedBenefitsFragment.getActivity(), unUsedBenefitsFragment.getString(R.string.login_error_message));
					UserInfoApplication.getInstance().exitForLogin(unUsedBenefitsFragment.getActivity());
					break;
				case Constant.APP_VERSION_ERROR:
					...
					FileCache fileCache = new FileCache(unUsedBenefitsFragment.getActivity());
					unUsedBenefitsFragment.packageUpdateUtil = new PackageUpdateUtil(unUsedBenefitsFragment.getActivity(), unUsedBenefitsFragment.mHandler, fileCache, downloadFileUrl, false, unUsedBenefitsFragment.userinfoApplication);
				...
				case 5:
					...
					File file = unUsedBenefitsFragment.getActivity().getFileStreamPath(filename);
					file.getName();
