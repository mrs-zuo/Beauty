...
public class DispenseOrderListAdapter extends BaseAdapter {
    ...
    private List<OrderProduct> mUserInfoAppOrderProductList;

    public DispenseOrderListAdapter(Context context, List<OrderProduct> orderProductList, List<OrderProduct> mUserInfoAppOrderProductList) {
        this.mContext = context;
        this.layoutInflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.mOrderProductList = orderProductList;
        this.mUserInfoAppOrderProductList = mUserInfoAppOrderProductList;
    }
                        ...
                        .setPositiveButton(mContext.getString(R.string.delete_confirm), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if (mOrderProductList != null && mOrderProductList.size() > pos) {
                                    mUserInfoAppOrderProductList.remove(mOrderProductList.get(pos));
