...
public class TreatmentServiceDetailActivity extends BaseActivity implements
    ...
    private static class TreatmentServiceDetailActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (treatmentServiceDetailActivity.requestWebServiceThread != null) {
                treatmentServiceDetailActivity.requestWebServiceThread.interrupt();
                treatmentServiceDetailActivity.requestWebServiceThread = null;
            }
            if (msg.what == 1) {
