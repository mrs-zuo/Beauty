...
public class TreatmentGroupDetailActivity extends BaseActivity implements
    ...
    private static class TreatmentGroupDetailActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (treatmentGroupDetailActivity.requestWebServiceThread != null) {
                treatmentGroupDetailActivity.requestWebServiceThread.interrupt();
                treatmentGroupDetailActivity.requestWebServiceThread = null;
            }
            if (msg.what == 1) {
