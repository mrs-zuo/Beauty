...
public class OpportunityAdvancedSearchActivity extends Activity implements OnClickListener{
	...
	private void saveConditionToSharePre(OpportunityListBaseConditionInfo currentCondition) {
		...
		String key = sharePreUtil.getAdvancedConditionKey(userinfoApplication.getAccountInfo().getAccountId(),userinfoApplication.getAccountInfo().getBranchId(),AdvancedFilterFlag.OpportunityFlag);
