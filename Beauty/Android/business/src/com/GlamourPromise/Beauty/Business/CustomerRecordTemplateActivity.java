...
public class CustomerRecordTemplateActivity extends BaseActivity implements OnItemClickListener, OnClickListener, IXListViewListener, Callback {
    ...
    private static class CustomerRecordTemplateActivityHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            customerRecordTemplateActivity.dismissDialog();
            if (customerRecordTemplateActivity.requestWebServiceThread != null) {
                customerRecordTemplateActivity.requestWebServiceThread.interrupt();
                customerRecordTemplateActivity.requestWebServiceThread = null;
            }
