...
import com.GlamourPromise.Beauty.adapter.CustomerVocationListAdapter;
...
public class CustomerRecordActivity extends BaseActivity implements OnClickListener {
    ...
    private static class CustomerRecordActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (customerRecordActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
    ...
    protected void onDestroy() {
        ...
        if (mTheadDownRecordList != null) {
            mTheadDownRecordList.interrupt();
            mTheadDownRecordList = null;
        }
    }
