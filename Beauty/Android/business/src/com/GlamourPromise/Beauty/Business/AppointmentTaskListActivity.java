...
public class AppointmentTaskListActivity extends BaseActivity implements OnClickListener, OnItemClickListener, IXListViewListener {
    ...
    private static class AppointmentTaskListActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (appointmentTaskListActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
            ...
            if (appointmentTaskListActivity.requestWebServiceThread != null) {
                appointmentTaskListActivity.requestWebServiceThread.interrupt();
                appointmentTaskListActivity.requestWebServiceThread = null;
            }
