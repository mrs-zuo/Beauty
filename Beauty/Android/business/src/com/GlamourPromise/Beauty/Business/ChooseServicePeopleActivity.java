...
import com.GlamourPromise.Beauty.adapter.ChoosePersonLeftAdapter;
import com.GlamourPromise.Beauty.adapter.LabelListAdapter;
import com.GlamourPromise.Beauty.adapter.PersonScheduleItemAdapter;
...
import com.GlamourPromise.Beauty.bean.PersonSchedule;
import com.GlamourPromise.Beauty.bean.ServerPackageVersion;
import com.GlamourPromise.Beauty.constant.Constant;
import com.GlamourPromise.Beauty.implementation.GetTagListTaskImpl;
import com.GlamourPromise.Beauty.util.BitmapUtils;
...
import com.GlamourPromise.Beauty.view.SyncHorizontalScrollView;
...
public class ChooseServicePeopleActivity extends BaseActivity implements
    ...
    private static class ChooseServicePeopleActivityHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (chooseServicePeopleActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
