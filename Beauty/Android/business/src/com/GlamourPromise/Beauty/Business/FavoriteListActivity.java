...
public class FavoriteListActivity extends BaseActivity implements
    ...
    private static class FavoriteListActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (favoriteListActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
            if (favoriteListActivity.requestWebServiceThread != null) {
                favoriteListActivity.requestWebServiceThread.interrupt();
                favoriteListActivity.requestWebServiceThread = null;
            }
            switch (msg.what) {
                case 1:
