...
public class AppointmentTaskSearchActivity extends BaseActivity implements OnClickListener {
    ...
    private void saveConditionToSharePre() {
        ...
        String key = sharePreUtil.getAdvancedConditionKey(userinfoApplication.getAccountInfo().getAccountId(), userinfoApplication.getAccountInfo().getBranchId(), AdvancedFilterFlag.AppointmentTaskFlag);
