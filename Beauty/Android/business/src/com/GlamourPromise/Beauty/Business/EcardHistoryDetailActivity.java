...
import com.GlamourPromise.Beauty.bean.BalanceCard;
import com.GlamourPromise.Beauty.bean.BenefitPerson;
import com.GlamourPromise.Beauty.bean.DownloadInfo;
import com.GlamourPromise.Beauty.bean.EcardActionMode;
import com.GlamourPromise.Beauty.bean.EcardHistoryDetail;
...
import com.GlamourPromise.Beauty.util.MathUtil;
...
public class EcardHistoryDetailActivity extends BaseActivity {
    ...
    private static class EcardHistoryDetailActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (ecardHistoryDetailActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
