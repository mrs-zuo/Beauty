...
import com.GlamourPromise.Beauty.adapter.VisitTaskListAdapter;
 ...
 * 回访筛选
 * */
public class VisitTaskListActivity extends BaseActivity implements OnClickListener, OnItemClickListener, IXListViewListener {
    ...
    private static class VisitTaskListActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (visitTaskListActivity.requestWebServiceThread != null) {
                visitTaskListActivity.requestWebServiceThread.interrupt();
                visitTaskListActivity.requestWebServiceThread = null;
            }
