...
public class EditTreatmentTreatmentDetailActivity extends BaseActivity implements OnClickListener {
    ...
    private static class EditTreatmentTreatmentDetailActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (editTreatmentTreatmentDetailActivity.exit) {
                // 用户返回不做任何处理
                return;
            }
            ...
            if (editTreatmentTreatmentDetailActivity.requestWebServiceThread != null) {
                editTreatmentTreatmentDetailActivity.requestWebServiceThread.interrupt();
                editTreatmentTreatmentDetailActivity.requestWebServiceThread = null;
            }
            if (msg.what == 1) {
