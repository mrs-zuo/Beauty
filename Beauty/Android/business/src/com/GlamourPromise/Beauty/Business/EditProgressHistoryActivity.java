...
public class EditProgressHistoryActivity extends BaseActivity implements
    ...
    private static class EditProgressHistoryActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (editProgressHistoryActivity.requestWebServiceThread != null) {
                editProgressHistoryActivity.requestWebServiceThread.interrupt();
                editProgressHistoryActivity.requestWebServiceThread = null;
            }
            if (msg.what == 1) {
