...
public class AppointmentDetailActivity extends BaseActivity implements OnClickListener {
    ...
    private static class AppointmentDetailActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (appointmentDetailActivity.requestWebServiceThread != null) {
                appointmentDetailActivity.requestWebServiceThread.interrupt();
                appointmentDetailActivity.requestWebServiceThread = null;
            }
            switch (msg.what) {
                case 0:
