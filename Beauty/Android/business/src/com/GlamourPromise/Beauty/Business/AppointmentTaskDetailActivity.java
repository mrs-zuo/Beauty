...
import com.GlamourPromise.Beauty.util.DateTimePickDialogUtil;
...
public class AppointmentTaskDetailActivity extends BaseActivity implements OnClickListener {
    ...
    private static class AppointmentTaskDetailActivityHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (appointmentTaskDetailActivity.requestWebServiceThread != null) {
                appointmentTaskDetailActivity.requestWebServiceThread.interrupt();
                appointmentTaskDetailActivity.requestWebServiceThread = null;
            }
            switch (msg.what) {
                case 0:
