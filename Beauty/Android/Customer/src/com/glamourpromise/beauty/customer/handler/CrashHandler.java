...
//        	UserInfoApplication.getInstance().AppExit();
    ...
    private boolean handleException(Throwable ex) {  
        ...
        new Thread() {  
            ...
            public void run() {  
                ...
                Looper.prepare();  
                //Toast.makeText(mContext, "出错啦:" + msg, Toast.LENGTH_LONG).show();  
                //Toast.makeText(mContext, "抱歉，程序出错啦，请重新尝试！", Toast.LENGTH_LONG).show();  
                Looper.loop();  
            }  
        }.start();  
        // 收集设备信息  
