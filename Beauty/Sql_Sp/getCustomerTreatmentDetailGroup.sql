...
if object_id('getCustomerTreatmentDetailGroup', 'p') is not null
begin
  drop procedure getCustomerTreatmentDetailGroup
end
go

create procedure getCustomerTreatmentDetailGroup
