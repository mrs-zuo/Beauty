...
if object_id('getCommodityRevenueGroup', 'p') is not null
begin
  drop procedure getCommodityRevenueGroup
end
go

create procedure getCommodityRevenueGroup
