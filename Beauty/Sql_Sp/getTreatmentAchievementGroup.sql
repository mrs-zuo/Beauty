...
if object_id('getTreatmentAchievementGroup', 'p') is not null
begin
  drop procedure getTreatmentAchievementGroup
end
go

create procedure getTreatmentAchievementGroup
