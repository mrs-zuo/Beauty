...
if object_id('getBranchCommodityDeatilReport', 'p') is not null
begin
  drop procedure getBranchCommodityDeatilReport
end
go


CREATE procedure getBranchCommodityDeatilReport
...
begin
   ...
   (SELECT  T5.PaymentID,
    ...
    FROM ( 
          ...
          INNER JOIN   [ORDER] T2 ON T2.ID = T1.OrderID AND T2.PaymentStatus > 0  and  T2.ProductType =1  
