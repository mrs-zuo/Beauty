...
if object_id('getCustomerDetailListCommodityDefault', 'p') is not null
begin
  drop procedure getCustomerDetailListCommodityDefault
end
go

create procedure getCustomerDetailListCommodityDefault
...
--顾客消费分析-商品Commodity productType != 0 obejectType != 0, 3（周期报表）
SELECT
  T7.Name ObjectName,
  T8.TotalPrice,
  T8.Quantity,
