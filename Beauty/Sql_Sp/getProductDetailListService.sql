...
if object_id('getProductDetailListService', 'p') is not null
begin
  drop procedure getProductDetailListService
end
go

create procedure getProductDetailListService
...
--服务销售分析-服务service productType = 0 obejectType = 0 （个人/员工）
SELECT
    T8.ObjectName,
