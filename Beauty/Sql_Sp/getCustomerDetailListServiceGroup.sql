...
if object_id('getCustomerDetailListServiceGroup', 'p') is not null
begin
  drop procedure getCustomerDetailListServiceGroup
end
go

create procedure getCustomerDetailListServiceGroup
...
--顾客消费分析-服务service productType = 0 obejectType = 3（分组）
SELECT
  T7.Name ObjectName,
  T8.TotalPrice,
  T8.Quantity,
