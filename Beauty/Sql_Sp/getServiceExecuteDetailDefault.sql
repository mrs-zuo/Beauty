...
if object_id('getServiceExecuteDetailDefault', 'p') is not null
begin
  drop procedure getServiceExecuteDetailDefault
end
go

create procedure getServiceExecuteDetailDefault
