...
if object_id('getProductDetailListServiceGroup', 'p') is not null
begin
  drop procedure getProductDetailListServiceGroup
end
go

create procedure getProductDetailListServiceGroup
...
--服务销售分析-服务Service productType = 0 obejectType = 3 （分组）
SELECT
    T8.ObjectName,
