...
if object_id('getCustomerDetailListServiceDefault', 'p') is not null
begin
  drop procedure getCustomerDetailListServiceDefault
end
go

create procedure getCustomerDetailListServiceDefault
...
--顾客消费分析-服务service productType = 0 obejectType != 0, 3（周期报表）
SELECT
  T7.Name ObjectName,
  T8.TotalPrice,
  T8.Quantity,
