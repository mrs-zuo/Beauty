...
if object_id('getCustomerDetailListCommodity', 'p') is not null
begin
  drop procedure getCustomerDetailListCommodity
end
go

create procedure getCustomerDetailListCommodity
...
--顾客消费分析-商品Commodity productType != 0 obejectType = 0（个人/员工）
SELECT
  T7.Name ObjectName,
  T8.TotalPrice,
  T8.Quantity,
