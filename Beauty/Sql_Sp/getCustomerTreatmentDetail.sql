...
if object_id('getCustomerTreatmentDetail', 'p') is not null
begin
  drop procedure getCustomerTreatmentDetail
end
go

create procedure getCustomerTreatmentDetail
