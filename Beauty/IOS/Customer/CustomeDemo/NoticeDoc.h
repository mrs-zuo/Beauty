...
@property(copy,nonatomic) NSString *notice_Title;
@property(copy,nonatomic) NSString *notice_Content;
@property(copy,nonatomic) NSString *notice_StartDate;
@property(copy,nonatomic) NSString *notice_EndDate;
