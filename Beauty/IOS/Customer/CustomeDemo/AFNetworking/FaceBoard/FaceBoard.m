...
- (id)init {
    ...
    if (self) {
     ...
     _faceMap =  [NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle]pathForResource:@"ExpressionImage" ofType:@"plist"]];
        ...
        //表情盘
        faceView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 5, 320, 160)];
        faceView.pagingEnabled = YES;
        //faceView.backgroundColor = [UIColor redColor];
        faceView.contentSize = CGSizeMake((FACE_COUNT_ALL / FACE_COUNT_PAGE + 1) * 320, 160 - 88);
        ...
        back.frame = CGRectMake(272, 152, 38, 28);
