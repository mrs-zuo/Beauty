...
-(void)addData
{
    ...
    [customerImage setImageWithURL:[NSURL URLWithString:@"http://beauty.glamise.com/assets/img/customerdownload.png"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType) {
    ...
    [businessImage setImageWithURL:[NSURL URLWithString:@"http://beauty.glamise.com/assets/img/businessdownload.png"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType) {
