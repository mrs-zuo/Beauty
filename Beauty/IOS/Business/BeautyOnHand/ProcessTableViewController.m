...
- (void)initData
{
    ...
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:@"testTwo"];
}
...
- (void)updateData
{
    ...
    NSLog(@"the tableView is %@", self.tableView);
    NSLog(@"the firstButton is %@", self.firstButton);
    NSLog(@"the secondButton is %@", self.secondButton);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"testTwo" forIndexPath:indexPath];
    
    cell.textLabel.text = [NSString stringWithFormat:@"second cell %ld",(long)indexPath.row];
