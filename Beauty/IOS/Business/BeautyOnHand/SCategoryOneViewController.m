...
@interface SCategoryOneViewController ()<SelectServiceControllerDelegate>
...
@implementation SCategoryOneViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row == 0) {
        ...
        if (categoryDoc.NextCategoryCount == 0) {
            ...
            SCategoryTwoViewController *categoryTwoVC = [self.storyboard instantiateViewControllerWithIdentifier:@"SCategoryTwoViewController"];
            categoryTwoVC.parentCategory = categoryDoc;
            categoryTwoVC.returnViewTag = self.returnViewTag;
